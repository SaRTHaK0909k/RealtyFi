    ...
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <Button className="gap-2 rounded-full px-5 shadow-sm">
            <Plus className="h-4 w-4" />
            Create Property
          </Button>
        </DialogTrigger>
        <DialogContent className="max-w-2xl rounded-3xl border border-border/60 bg-background/95 px-0 pb-0 shadow-2xl">
          <div className="border-b border-border/70 px-6 pb-4 pt-6">
            <DialogHeader>
              <DialogTitle className="text-2xl font-semibold">Create New Property</DialogTitle>
              <p className="text-sm text-muted-foreground">Provide property details, upload media, and confirm on-chain listing.</p>
            </DialogHeader>
          </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-2xl border border-dashed border-border/70 p-4 text-center">
                  ...
                  {imagePreview && (
                    <div className="mt-3 h-32 w-full overflow-hidden rounded-xl">
                      <img
                        src={imagePreview}
                        alt="Preview"
